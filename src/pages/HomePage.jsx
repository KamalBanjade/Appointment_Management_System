        ...
        <div className="p-6 bg-gray-100 min-h-screen">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div className="bg-white shadow rounded-lg p-4">
                    ...
                    <p className="text-3xl font-semibold text-blue-500 mt-2">{stats.visitorsToday}</p>
                </div>
                <div className="bg-white shadow rounded-lg p-4">
                    <h3 className="text-xl font-bold text-gray-700">Upcoming Appointments</h3>
                    <p className="text-3xl font-semibold text-green-500 mt-2">{stats.upcomingAppointments}</p>
                </div>
                <div className="bg-white shadow rounded-lg p-4">
                    <h3 className="text-xl font-bold text-gray-700">Active Employees</h3>
                    <p className="text-3xl font-semibold text-purple-500 mt-2">{stats.activeEmployees}</p>
                </div>
            </div>
