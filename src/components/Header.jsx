...
const Header = () => {
  ...
  return (
    <nav className="w-full py-2 bg-white border-b-4 border-green-600 shadow-lg relative z-50">
  <div className="container mx-auto px-2  flex items-center justify-between"> {/* Reduced padding here */}
    {/* Logo Section */}
    <NavLink
      to="/"
